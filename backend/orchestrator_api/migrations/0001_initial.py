    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deleted_at', models.DateTimeField(blank=True, null=True)),
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('status', models.CharField(choices=[('Pending', 'Pending'), ('Queued', 'Queued'), ('Nmap Scan Running', 'Nmap Scan Running'), ('Nmap Scan Completed', 'Nmap Scan Completed'), ('Finger Scan Running', 'Finger Scan Running'), ('Finger Scan Completed', 'Finger Scan Completed'), ('Enum Scan Running', 'Enum Scan Running'), ('Enum Scan Completed', 'Enum Scan Completed'), ('Web Scan Running', 'Web Scan Running'), ('Web Scan Completed', 'Web Scan Completed'), ('Vuln Lookup Running', 'Vuln Lookup Running'), ('Vuln Lookup Completed', 'Vuln Lookup Completed'), ('Report Generation Running', 'Report Generation Running'), ('Completed', 'Completed'), ('Failed', 'Failed')], default='Pending', max_length=50)),
                ...
                ('parsed_enum_results', models.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enum_started_at', models.DateTimeField(blank=True, null=True)),
                ('enum_completed_at', models.DateTimeField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('plugin_enum', models.BooleanField(default=False, help_text='Enable enumeration plugin')),
